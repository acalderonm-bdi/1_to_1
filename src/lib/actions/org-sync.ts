 ...
 *
 * Nota: para el PRIMER import masivo conviene el CLI `pnpm org-sync` (sin
 * límite de tiempo serverless). Esta acción es ideal para re-syncs
 * incrementales (diffs chicos).
 */
